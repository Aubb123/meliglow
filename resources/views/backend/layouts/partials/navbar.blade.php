                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item list-group-item-action dropdown-notifications-item">
                                <div class="d-flex">
                                    <div class="flex-shrink-0 me-3">
                                        <div class="avatar">
                                            <img src="{{ asset(getEnvFolder() . 'backend/assets/img/avatars/1.png') }}" alt="avatar" class="rounded-circle">
                                        </div>
                                    </div>
                            ...
                            <li
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0 me-3">
                                        <div class="avatar">
                                            <img src="{{ asset(getEnvFolder() . 'backend/assets/img/avatars/2.png') }}"
            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                        <img src="{{ auth()->user()->getCoverImageUrl()['url_img'] }}" alt="alt" style="width: 40px; height: 40px; border-radius: 100px;">
                    </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end mt-3 py-2">
                    <li>
                        <a class="dropdown-item" href="#">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    <h6 class="mb-0 small">{{ auth()->user()->lastname }} {{ auth()->user()->firstname }}</h6>
                    ...
                    <li>
                        <div class="d-grid px-4 pt-2 pb-1">
                            <form class="btn btn-sm btn-danger d-flex" method="POST" action="{{ route('logout') }}">
                                @csrf
                                <button type="submit" class="btn btn-sm btn-danger d-flex">
                                    <small class="align-middle">Déconnexion
                                    </small> <i class="icon-base ri ri-logout-box-r-line ms-2 icon-16px"></i>
                                </button>
                            </form>
                        </div>
                    </li>
