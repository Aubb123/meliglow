            ...
            <div class="col-md-12 col-xxl-12">
                <div class="card">
                    ...
                    <div class="card-body demo-vertical-spacing demo-only-element">
                        <form action="{{ route('backend.product_categories.update', $category->token) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-floating form-floating-outline mb-6">
                                        <input class="form-control @error('name') is-invalid @enderror" id="name" name="name" type="text" placeholder="Exemple : Perruques, Huiles capillaires..." value="{{ old('name', $category->name) }}" required >
                                ...
                                <div class="col-md-12">
                                    <div class="form-floating form-floating-outline mb-6">
                                        <textarea class="form-control @error('description') is-invalid @enderror" name="description" id="description" placeholder="Description de la catégorie" rows="5" >{{ old('description', $category->description) }}</textarea>
...
@section('summernote')
    ...
    @endif
    <script>
        var initialContent = "{!! addslashes($category->description) !!}";
