            ...
            <div class="col-md-12 col-xxl-12">
                <div class="card">
                    ...
                    <div class="card-body demo-vertical-spacing demo-only-element">
                        <form action="{{ route('backend.tags.store') }}" method="POST" enctype="multipart/form-data" >
                            @csrf
                            <div class="row">   
                                <div class="form-floating form-floating-outline mb-6">
                                    <input class="form-control" id="name" name="name" type="text" placeholder="Tag1" value="{{ old('name', '') }}" required>
